...
const Mosque_request_management = () => {
  const [user,setUser]=useState([]);
  useEffect(()=>{
     axios.get('http://localhost:9000/newmosque/get')
    .then(res =>{
      console.log(res)
      setUser(res.data)
    })
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">New mosque request history</h4>
...
export default Mosque_request_management
