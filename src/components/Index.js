...
import Blood_request_management from './Blood_request_management'
import Footer from './Footer'
import Header from './Header'
import Mosque from './Mosque'
import Mosque_request_management from './Mosque_request_management'
import './Card.css'
...
const Index = () => {
  ...
  const handleCardClickmfund = () => {
    window.location.href = '/admin/mosque';
  };
  const handleCardClickbrequest =()=>{
    window.location.href = '/admin/blood-request';
  }
  const handleCardClickbdonate=()=>{
    window.location.href = '/admin/blood-donate';
  }
  const handleCardClicknmrequest =()=>{
    window.location.href = '/admin/mosque-request';
  }
  ...
  const handleCardClicknfund=()=>{
    window.location.href = '/admin/needypeople';
  }
  const handleCardClickmrequest =()=>{
    window.location.href = '/admin/mosque-maintinance';
  }
