...
const Fbrmembermosquefund = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:9000/member/fund/get')
      .then(res => {
        console.log(res);
        setUser(res.data);
      })
  ...
  const filterUser = (filter) => {
    ...
    calculateTotalFunds(filteredData);
  };
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">FBR check mosque fund</h4>
...
{/* <div className="filters">
  ...
  <button
    ...
    className={`btn btn-cyan m-l-15 ${selectedFilter === 'monthly' ? 'active' : ''}`}
    style={{backgroundColor:'darkcyan',color:'white'}}
  >
    Monthly
  </button>
...
export default Fbrmembermosquefund
