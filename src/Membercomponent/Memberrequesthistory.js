...
const Memberrequesthistory = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:9000/blood-request/get')
      .then(res => {
        console.log(res);
        setUsers(res.data);
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">My blood request history</h4>
...
export default Memberrequesthistory
