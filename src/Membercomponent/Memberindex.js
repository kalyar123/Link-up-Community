...
const Memberindex = () => {
  ...
  const handleCardClick = () => {
    ...
    window.location.href="/member/mosque"
  };
  ...
  const handleCardClickbrequest =()=>{
    window.location.href = '/member/blood-request';
  }
  const handleCardClickbdonate=()=>{
    window.location.href = '/member/blood-donate';
  }
  const handleCardClicknmrequest =()=>{
    window.location.href = '/member/newmosque-request';
  }
  ...
  const handleCardClicknfund=()=>{
    window.location.href = '/member/needypeople';
  }
  const handleCardClickmrequest =()=>{
    window.location.href = '/member/mosque-maintinance';
  }
