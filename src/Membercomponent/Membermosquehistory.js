...
const Membermosquehistory = () => {
  const [records, setRecords] = useState([]);
  const [loggedInUserEmail, setLoggedInUserEmail] = useState('');

  useEffect(() => {
    axios
      .get('http://localhost:9000/member/newmosque/get')
      .then(res => {
        console.log(res);
        setRecords(res.data);
      })
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Member mosque request history</h4>
...
export default Membermosquehistory
